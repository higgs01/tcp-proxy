...
async fn transfer(mut inbound: TcpStream, proxy_addr: String) -> Result<(), Box<dyn Error>> {
    ...
    wo.write_all(&[0x0D, 0x0A, 0x0D, 0x0A, 0x00, 0x0D, 0x0A, 0x51, 0x55, 0x49, 0x54, 0x0A,
        0x21, // 0020 0001 (default, proxy)
        0x11, // 0001 0001 (IPV4, STREAM)
        0x00, 0x0C, // length (12)
            0x7F, 0x11, 0x00, 0x01, // 127.17.0.1
            0x7F, 0x00, 0x00, 0x01,
            0xd3, 0x69,
            0x63, 0xe9]).await;
